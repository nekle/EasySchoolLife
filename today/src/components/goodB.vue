                  ...
                  <div class="demo-image">
                    ...
                    <el-container direction="vertical">
                      <el-image
                        ...
                        :src="url"
                        :fits="fit"
                        @click="accountInfo(account.account,account.money,account.userid,account.create_time,account.type,account.id)"
                      ></el-image>
                      <el-container>
...
export default {
  name: 'goodB',
  methods: {
    accountInfo (account, money, userid, createtime, type, id) {
      console.log(account)
      this.$router.push({path: '/goodInfoBiliBili',
        query: {
          account: account,
          money: money,
          userId: userid,
  ...
  data () {
    return {
      accounts: [],
      url: 'http://img0.imgtn.bdimg.com/it/u=825208488,1292941794&fm=26&gp=0.jpg',
